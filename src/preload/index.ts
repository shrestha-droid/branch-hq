...
contextBridge.exposeInMainWorld('api', {
  ...
  invokeAgent: (conversationId: string, agentName: 'jim' | 'dwight' | 'pam', prompt: string) => 
...
declare global {
  interface Window {
    api: {
      ...
      invokeAgent: (conversationId: string, agentName: 'jim' | 'dwight' | 'pam', prompt: string) => Promise<{ success: boolean; messages?: any[]; error?: string }>;
